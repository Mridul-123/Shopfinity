            ...
            <div className='bg-white p-2 mt-4'>
                <div className='container flex gap-3'>
                    ...
                    <div className='rightContent w-[80%] py-3'>
                        ...
                        <div className='pb-3'>
                            <div className='bg-[#f1f1f1] p-2 w-full rounded-mb flex items-center justify-between'>
                                ...
                                <div className='col2 ml-auto flex items-center justify-end'>
                                    <span className='text-[14px] font-[500] pr-2  text-[rgba(0,0,0,0.7)] '>Sort By</span>
                                    <Button
                                        id="basic-button"
                                        ...
                                        onClick={handleClick}
                                        className='!bg-white !text-[12px] !text-[#000] !capitalize !font-[600] !border-2 !border-[rgba(0,0,0,0.1)] !px-4 !py-1 rounded-md'
                                    >
                        ...
                        <div className='flex items-center justify-center mt-10 pt-4'>
