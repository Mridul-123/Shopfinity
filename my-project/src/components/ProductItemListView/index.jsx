    ...
    return (
        <div className='productItem shadow-lg rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)] flex items-center pl-3'>
            ...
            <div className='info p-3 py-4 px-8 w-[75%]'>
                <h6 className='text-[15px]'><Link to='/' className='link transition-all'>Product Name</Link></h6>
                <h3 className='text-[18px] title pt-3 pb-3 font-[500] mb-1 text-[#000]'> 
                    <Link to='/' className='link transition-all'>Siril Georgette Pino Color Saree with Blouse piece</Link>
                    <p className='text-[14px] pt-3'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi inventore quis nobis debitis fuga quae maxime facilis? Veniam laborum magni deleniti hic, enim sed earum, eum velit expedita vel cupiditate!
                    </p>
                </h3>
